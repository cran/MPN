...
and Jarvis et al. (
[6](https://doi.org/10.1111/j.1365-2672.2010.04792.x)
...
calculated for the Most Probable Number. Currently, the **MPN** package computes
a CI using the approach of Jarvis et al.
(
[6](https://doi.org/10.1111/j.1365-2672.2010.04792.x)
) or the likelihood ratio approach of Ridout (*7*).
...
5. Haas CN, Rose JB, Gerba CP (2014). "Quantitative microbial risk assessment,
Second Ed." *John Wiley & Sons, Inc.*, ISBN 978-1-118-14529-6.

6. Jarvis B, Wilrich C, Wilrich P-T (2010). "Reconsideration of the derivation
...
7. Ridout MS (1994). "A Comparison of Confidence Interval Methods for Dilution
